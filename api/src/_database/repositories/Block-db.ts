...
import { IBlockRepository } from "../../types/DB-types"



class BlockRepository {
	static async createBlock({ interCode, deviceId, userId, lockTime, unlockTime, deviceIP, fingerprintHash }: IBlockRepository) {
